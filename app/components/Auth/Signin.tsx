  ...
  return (
    <>
      ...
      <Select data={[
        ...
        'United States (+1)', 'United States (+1)', 'United States (+1)'
      ]} />
      ...
      />
      {
        !isPetSitter ? (
          ...
          <Fragment>
            <Label title="What kind of pets do you have?" compulsory />
            <CheckBox
              data={['Dogs', 'Cats']}
              handleData={(str) => { console.log(str) }}
              multiple
